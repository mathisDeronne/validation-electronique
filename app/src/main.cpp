...
void AppMain()
{
    ...
    // GPIO INIT
    //--------------------------------------------------------------
    gpio_set_direction((gpio_num_t)HardwareConfig::IHM::LED_GREEN, GPIO_MODE_OUTPUT);
    gpio_set_direction((gpio_num_t)HardwareConfig::IHM::LED_RED, GPIO_MODE_OUTPUT);
    gpio_set_direction((gpio_num_t)HardwareConfig::IHM::BUZZER, GPIO_MODE_OUTPUT);
    ...
    while (true)
    {
        gpio_set_level((gpio_num_t)HardwareConfig::IHM::LED_GREEN, 1);
        vTaskDelay(pdMS_TO_TICKS(300));
        gpio_set_level((gpio_num_t)HardwareConfig::IHM::LED_GREEN, 0);

        gpio_set_level((gpio_num_t)HardwareConfig::IHM::LED_RED, 1);
        vTaskDelay(pdMS_TO_TICKS(300));
        gpio_set_level((gpio_num_t)HardwareConfig::IHM::LED_RED, 0);
